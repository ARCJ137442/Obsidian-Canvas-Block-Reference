...
import { filteredDatasByKey, getActiveCanvasView, registerCanvasMenuItem, selectedEdgesIncludesBetweens, updateEdgeData } from "src/utils";
...
/** 反转选取内的边对象 */
export function reverseSelectedEdges(canvas: Canvas): void {
